            ...
            <div class="box-content">
                <form role="form" method="post">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Minimum</label><br/>
						<input type="txt" name="txtMinPrice" value=" " class="form-control">
						
                    </div>
					<div class="form-group">
                        <label for="exampleInputEmail1">Maximum</label><br/>
						<input type="txt" name="txtMaxPrice" value=" " class="form-control">
						 
                    </div>
					
						<button type="submit" class="btn btn-default" name="btnsub">Generate Report</button>
						<button type="submit" class="btn btn-default" name="btnsub">View in Exl</button>
				</form>
...
<div class="row">
	...
	<?php
		$query="SELECT addp.*, r.name 'UserName'
				...
				WHERE addp.price BETWEEN ".$_POST["txtMinPrice"]." AND ".$_POST["txtMaxPrice"];
