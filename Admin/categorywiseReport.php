                ...
                <form role="form" method="post">
					...
					<div class="form-group">
                        <label for="exampleInputEmail1">SubCategory</label>
						 <select  name="ddlSubCategory"  id="ddlSubCategory" class="form-control" placeholder="SubCategory">
...
<div class="row">
	...
	<?php
		$query="SELECT addp.*, r.name 'UserName'
				...
				WHERE addp.cid=".$_POST["ddlCategory"]." AND addp.subcategoryid=".$_POST["ddlSubCategory"];
		$returnVal=mysql_query($query);
		if(mysql_num_rows($returnVal) > 0)
		{
			while($row=mysql_fetch_array($returnVal))
