<?php	
 ...
 {   
	 ...
	 $query="SELECT * FROM admin_login WHERE uname='$username' && pwd='$password'";
...
<div class="ch-container">
    ...
    <div class="row">
        <div class="col-md-12 center login-header">
            <h2>Welcome to SmartDeal4u Admin Login</h2>
        </div>
        <!--/span-->
    </div><!--/row-->
            ...
            <form class="form-horizontal"  method="post">
                <fieldset>
                    <div class="input-group input-group-lg">
                        ...
                        <input type="text"  name="uname1" class="form-control" placeholder="Username">
                    </div>
