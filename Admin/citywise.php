            ...
            <div class="box-content">
                <form role="form" method="post">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Select City</label><br/>
						 <select  name="ddlcity"  id="ddlSubCategory" class="form-control" placeholder="Select City">
