            ...
            <div class="box-content">
                <form role="form" method="post">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Select Itemtype</label><br/>
						 <select  name="txtitem"  id="ddlSubCategory" class="form-control">
                                                <option value="0">Select Itemtype</option>
...
<div class="row">
	...
	<?php
		$query="SELECT addp.*,r.name'UserName'
				...
				WHERE addp.itemtype='".$_POST["txtitem"]."'";
